...
#let document-annotation(id) = if id == "tz" [
  ...
  Настоящая Программа и методика испытаний для "Питомец.ком" содержит следующие разделы: «Объект испытаний», «Цель испытаний», «Требования к программе», «Требования к программной документации», «Средства и порядок испытаний», «Методы испытаний», «Приложения».
